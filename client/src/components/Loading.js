function Loading(){
    return(
        <div className='absolute w-full h-full bg-slate-300 bg-opacity-60 flex justify-center items-center'>
            <div className='flex flex-col items-center'>
                <svg className="w-20 h-20" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 300 300">
                <defs>
                ...
                <p className='ml-2 font-bold text-center'>Coffe Track</p>
                <div className="mt-2 font-bold text-center">Loading..</div>
            </div>
        </div>
    )
}
