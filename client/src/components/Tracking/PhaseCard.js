  ...
  return (
    <Card sx={{ maxWidth: 300 }} className="min-h-[350px] min-w-[300px]">
      ...
      <div className="absolute right-0 top-0 mt-8 mr-4">
        ...
        <Tooltip size="small" placement="top" title="En Proceso" sx={{ m: 0, p: 0, fontSize: '1.3875rem' }}><RunningWithErrorsRoundedIcon className="icon-warning" /></Tooltip>}
        {props.status === "No Disponible" && <Tooltip size="small" placement="top" title="No Disponible" sx={{ m: 0, p: 0, fontSize: '1.3875rem' }}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
